...
public class MainPageActivity extends AppCompatActivity {
   ...
   private CardView budgetCardView, todayCardView,historyCardView;
    ...
    private ImageView budgetBtnImageView, todayBtnImageView, weekBtnImageView, monthBtnImageView, analyticsBtnImageView;
    private TextView budgetValue, todayValue, weekValue, monthValue, savingValue;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        budgetValue = findViewById(R.id.tvBudgetValue);
        todayValue = findViewById(R.id.tvTodayValue);
        weekValue = findViewById(R.id.tvWeekValue);
        monthValue = findViewById(R.id.tvMonthValue);
        savingValue = findViewById(R.id.tvSavingsValue);
...
//                Intent intent = new Intent(MainPageActivity.this, TodaySpendingActivity.class);
...
//        });
        ...
        budgetBtnImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainPageActivity.this, BudgetActivity.class);
                startActivity(intent);
        ...
        weekBtnImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainPageActivity.this, WeekSpendingActivity.class);
        ...
        analyticsBtnImageView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(MainPageActivity.this, ChooseAnalyticActivity.class);
                startActivity(intent);
            }
        });
        ...
        budgetRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount() > 0) {
                    ...
                    Toast.makeText(MainPageActivity.this, "Please set a BUDGET", Toast.LENGTH_LONG).show();
                }
            }
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount() > 0) {
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        budgetValue.setText("$ " + String.valueOf(totalAmountBudget));

                    }
                } else {
                    totalAmountBudget = 0;
                    budgetValue.setText("$ " + String.valueOf(0));
                }
            }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount += pTotal;
                    todayValue.setText("$ " + totalAmount);
                }
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                for (DataSnapshot ds : snapshot.getChildren()) {
                    ...
                    int pTotal = Integer.parseInt(String.valueOf(total));
                    totalAmount += pTotal;
                    monthValue.setText("$ " + totalAmount);
                }
        ...
        personalRef.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    int savings = totalAmountBudget - monthSpending;
                    savingValue.setText("$ " + savings);
                }
            }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        if(item.getItemId()==R.id.account){
            Intent intent=new Intent(MainPageActivity.this,AccountActivity.class);
            startActivity(intent);
        }

...
public class DailyAnalyticsActivity extends AppCompatActivity {
    ...
    private TextView analyticsApparelAmount, analyticsPersonalExpensesAmount, analyticsOtherAmount, todaySpentAmount;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //general analytic
        todaySpentAmount = findViewById(R.id.todaySpentAmount);
        ...
        getTotalDailyExpense("Transport","expenses","dayTrans");
        getTotalDailyExpense("Food","expenses","dayFood");
        getTotalDailyExpense("House","expenses","dayHouse");
        getTotalDailyExpense("Entertainment","expenses","dayEnt");
        getTotalDailyExpense("Apparel","expenses","dayApp");
        getTotalDailyExpense("Personal","expenses","dayPer");
        getTotalDailyExpense("Other","expenses","dayOther");
        getTotalDaySpending();
    ...
    private void getTotalDailyExpense(String name,String ref,String ch) {
        MutableDateTime epoch = new MutableDateTime();
        epoch.setDate(0);
        DateFormat dateFormat = new SimpleDateFormat("dd-MM-yyyy");
        Calendar cal = Calendar.getInstance();
        String date = dateFormat.format(cal.getTime());
        String itemNday = name+date;
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    personalRef.child(ch).setValue(totalAmount);
                } else {
                    if(name.equals("Transport")){
        ...
        query.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount() > 0) {
                    ...
                    todaySpentAmount.setText("Total Spent: $" + totalAmount);
                } else {
                    totalBudgetAmountTextView.setText("You are not spent today");
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists()) {
                    ...
                    if (appPercent < 50) {
                        ...
                        progress_ratio_app.setText(perPercent + "%" + "used of" + appRatio + " Status");

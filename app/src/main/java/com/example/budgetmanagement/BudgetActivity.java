...
public class BudgetActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayoutManager linerLinearLayoutManager = new LinearLayoutManager(this);
        linerLinearLayoutManager.setStackFromEnd(true);
        linerLinearLayoutManager.setReverseLayout(true);
        recyclerView.setHasFixedSize(true);
        recyclerView.setLayoutManager(linerLinearLayoutManager);
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if (snapshot.exists() && snapshot.getChildrenCount() > 0) {
                    ...
                    for (DataSnapshot dataSnapshot : snapshot.getChildren()) {
                        ...
                        totalAmount += pTotal;
                        String strTotal = String.valueOf("Month Budget");
                        totalBudgetAmountTextView.setText(strTotal);
                    }
    ...
    private void additem() {
        ...
        save.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String budgItem = itemSpinner.getSelectedItem().toString();
                if (TextUtils.isEmpty(budgetAmount)) {
                    amount.setError("Amount is required!");
                    return;
                }
                if (budgItem.equals("Select item")) {
                    ...
                    String itemNday = budgItem + date;
                    String itemNweek = budgItem + weeks.getWeeks();
                    String itemNmonth = budgItem + months.getMonths();

                    Data data = new Data(budgItem, date, id, itemNday, itemNweek, itemNmonth, Integer.parseInt(budgetAmount), weeks.getWeeks(), months.getMonths(), null);
    ...
    public class MyViewHolder extends RecyclerView.ViewHolder {
        ...
        public MyViewHolder(@NonNull View iteView) {
            ...
            notes = iteView.findViewById(R.id.note);
        }
        ...
        btnUpdate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                budgetRef.child(post_key).setValue(data).addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        if (task.isSuccessful()) {
                            Toast.makeText(BudgetActivity.this, "Update succesfully", Toast.LENGTH_SHORT).show();
                        } else {
                            Toast.makeText(BudgetActivity.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                        }
                        loader.dismiss();
